...
public class Get06 extends RestfulBaseUrl {
    ...
    "additionalneeds": "None"
        ...
        // 3. yol: Soft Assertion. 3 adımda kullanılır
            // i - Obje oluşturma
        ...
        softAssert.assertEquals(json.getInt("totalprice"),616161,"Total price Hatali");
        ...
        // Eger sistemin sonunda softAssert.assertAlll() kullanmaz isek
        // taleplerimiz hatali olsa bile testimiz pass olacaktır.
