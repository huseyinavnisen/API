...
public class D1 extends AutomationExercieseBaseUrl {
// https://jsonpath.herokuapp.com/
    ...
    */
    ...
    public void test1() {
        ...
        List<Integer> idListi = jsonPath.getList("products.findAll{it.id>30}.name");
        System.out.println("idListi = " + idListi);
